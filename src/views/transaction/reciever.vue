<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="Số tài khoản" min-width="150px" align="center" prop="customerId"></el-table-column>
      <el-table-column label="Tên người nhận" min-width="150px" align="center" prop="name"></el-table-column>
    </el-table>
