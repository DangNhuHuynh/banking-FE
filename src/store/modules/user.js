import { login, getNewToken, logout, getInfo, changePass, resetPassword, confirmReset } from '@/api/user'
import {
  getToken,
  getUsername,
  setToken,
...
const actions = {
  ...
  login({ commit }, userInfo) {
    const { username, password, recaptcha_token } = userInfo
    return new Promise((resolve, reject) => {
      login({ username: username.trim(), password, recaptcha_token }).then(response => {
        const { data } = response
